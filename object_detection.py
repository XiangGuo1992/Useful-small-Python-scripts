...
PATH_TO_TEST_IMAGES_DIR = 'G:\\Resource for Xiang\\Lian Cui experiment\\eyetracking data\\2.New Experiment\\4.analysis\\framepics_base\\'
...
output_image_path = ('G:\\Resource for Xiang\\Lian Cui experiment\\eyetracking data\\2.New Experiment\\4.analysis\\output\\pics_base\\')
output_csv_path = ('G:\\Resource for Xiang\\Lian Cui experiment\\eyetracking data\\2.New Experiment\\4.analysis\\output\\csv_base\\')
...
for image_folder in TEST_IMAGE_DIRS:
    ...
    with detection_graph.as_default():
      with tf.Session(graph=detection_graph) as sess:
        ...
        data.columns = ['framename', 'ymin', 'xmin', 'ymax', 'xmax', 'scores', 'class']
